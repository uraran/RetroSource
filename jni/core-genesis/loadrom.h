...
/* Function prototypes */
extern int load_rom(void *buf, int rom_size, int system_type); // if 'rom_size' == 0 then 'buf' points to a filename, otherwise 'buf' points to a buffer 'rom_size' large containing the ROM
