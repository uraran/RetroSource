...
#define __INES_INCORRECT_H_
	...
	{0x37CB1801,	 -1,		4}, /* Top Gun (Japan) */
	{0xCF6D0D7A,	 -1,		4}, /* Top Gun (USA) (Rev A) */
	{0x2A01F9D1,	 206,		1}, /* Wagyan Land (Japan) */
	{0xDCDF06DE,	 206,		1}, /* Pro Yakyuu - Family Stadium (Japan) */
	{0xAE321339,	 206,		1}, /* Pro Yakyuu - Family Stadium '88 (Japan) */
	{0x1300A8B7,	 206,		1}, /* Pro Yakyuu - Family Stadium '87 (Japan) */
	{0x2E563C66,	 206,		1}, /* Mappy-Land (Japan) */
	{0x9D21FE96,	 206,		1}, /* Lupin Sansei - Pandora no Isan (Japan) */
	{0x9CBC8253,	 206,		1}, /* Family Circuit (Japan) */
