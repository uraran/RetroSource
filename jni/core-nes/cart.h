#ifndef __FCEU_CART_H_
#define __FCEU_CART_H_
...
// Added for retron
int FCEU_SaveGameSave2(const char *filename, CartInfo *LocalHWInfo);
int FCEU_SaveGameSaveBuffer2(void **buffer, int *buf_size, CartInfo *LocalHWInfo);
int FCEU_LoadGameSave2(const char *filename, CartInfo *LocalHWInfo);
