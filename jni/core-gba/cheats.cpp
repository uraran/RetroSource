...
/*
 * NOTE:
 * - mastercodes have been disabled; cheats applied at each H-BLANK.. will this be an issue for any games?
 * - cheats that use "extension" inputs unsupported for now
 * - slowdown cheats unsupported for now
 */
...
//    LOGI("cheat: %X:%X\n", cheatsList[i].address, cheatsList[i].value);
    switch(cheatsList[i].size) {
    case GSA_CODES_ON:
      onoff = true;
      break;
